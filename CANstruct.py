...
class VCI_CAN_OBJ(Structure):
    ...
    def __str__(self):
        ...
        return 'ID:%08X,时间戳:%X,数据长度:%X,数据:%02X %02X %02X %02X %02X %02X %02X %02X,电压:%.4f,电流:%.4f'%(self.ID,self.TimeStamp,self.DataLen,self.Data[0],self.Data[1],self.Data[2],self.Data[3],self.Data[4],self.Data[5],self.Data[6],self.Data[7],Voltage,Current)
